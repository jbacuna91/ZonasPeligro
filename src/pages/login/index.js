...
const LoginPage = () => {
  ...
  const onSubmit = data => {
    ...
    auth.login({ email, password, rememberMe }, () => {
      setError('email', {
        type: 'manual',
        message: 'E-mail o contraseña inválido'
      })
    })
  }
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              ...
              <Typography variant='body2'>Por favor ingrese sus datos para acceder</Typography>
            </Box>
            ...
            <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
                <Typography sx={{ mr: 2, color: 'text.secondary' }}>¿Nuevo en Procure Terreno?</Typography>
