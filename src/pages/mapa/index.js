...
const plantas = [
  {
    ...
    areas: [
      ...
      {
        paths: [
          { lat: -24.261989, lng: -69.060243 },
          { lat: -24.262791, lng: -69.059942 },
          { lat: -24.262779, lng: -69.059854 },
          { lat: -24.263676, lng: -69.059575 },
          { lat: -24.26361, lng: -69.059256 },
          { lat: -24.262952, lng: -69.059454 },
          { lat: -24.262952, lng: -69.059556 },
          { lat: -24.261898, lng: -69.059915 }
        ],
        name: 'Molienda',
      ...
      {
        paths: [
          { lat: -24.262018, lng: -69.060157 },
          { lat: -24.262713, lng: -69.059905 },
          { lat: -24.262705, lng: -69.059797 },
          { lat: -24.263603, lng: -69.059524 },
          { lat: -24.263578, lng: -69.059323 },
          { lat: -24.263006, lng: -69.059502 },
          { lat: -24.262996, lng: -69.059585 },
          { lat: -24.261955, lng: -69.059948 }
        ],
        name: 'Molienda',
  ...
  handlePolygonClick(e, index) {
    ...
    plantas.forEach(planta => {
      planta.areas.forEach(area => {
        if (google.maps.geometry.poly.containsLocation(e.latLng, new google.maps.Polygon({ paths: area.paths }))) {
          if (area.name === index) {
            peligros.push({ text: area.peligro, color: area.color })
          }
        }
      })
    })
    ...
    const content = (
      <div className={styles['info-window']}>
        <div className={styles['info-window-title']}>Título: {index}</div>
        <div className={styles['info-window-subtitle']}>Subtítulo: Peligro</div>
        <div>Contenido:</div>
